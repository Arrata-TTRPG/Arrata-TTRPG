  ...
  #align(center)[
    #pad(top: 14pt, left: 8pt, right: 8pt)[
      #talent(
        ...
        ob(melee, "Type", size: 11pt, style: "italic"),
        ob("Blade", "Skill req.", size: 11pt, style: "italic"),
        ub("Perform 2 attacks at 50% weapon damage each.", "Mechanical effect", size: 12pt),
        height: auto,
      )
    ]
  ]
  ...
  #align(center)[
    #pad(top: 14pt, left: 8pt, right: 8pt)[
      #weapon(
        ...
        ob(melee, "Weapon type", size: 14pt, weight: "bold"),
        ob("Blade", "Skill", size: 11pt, style: "italic"),
        ob("B3", "Req.", size: 11pt, style: "italic"),
        ob("3", "Base dmg", size: 31pt, weight: "bold"),
        ub("Physical", "Damage type", size: 12pt),
        stat-mod: ob("Power", "Stat mod.", size: 16pt, weight: "bold"),
        bonus: ub("+10%/Success over", "Per-success bonus", size: 11pt, style: "italic"),
        tags: (ob(two-handed, "Grip", size: 11pt, style: "italic"),),
        notes: (ob("May be used one-handed at -1 damage.", "Note", size: 11pt, style: "italic"),),
        height: auto,
      )
    ]
  ]
...
#slantedColorbox(title: "Armor Card", width: auto, radius: 0pt, color: black)[
  ...
  #align(center)[
    #pad(top: 14pt, left: 8pt, right: 8pt)[
      #armor(
        ob("Chain Mail", "Name", size: 16pt, weight: "bold"),
        (
          ub("-25% damage", "% damage reduction", size: 12pt),
          ub("-1 Evasion", "Stat penalty", size: 12pt),
        ),
        height: auto,
      )
    ]
