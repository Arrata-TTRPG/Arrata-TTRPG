...
#grid(
  ...
  armor("Brigandine", ("-20% damage", "-1 Evasion", "-25% incoming ranged damage")),
  armor("Splint Mail", ("-30% damage", "-2 Evasion")),

  armor("Half Plate", ("-30% damage", "-2 Evasion", "-1 Speed")),
  armor("Full Plate", ("-40% damage", "-3 Evasion", "-1 Speed", "-50% incoming ranged damage")),
  armor(
    "Fortress Plate",
    ("-50% damage", "-4 Evasion", "-2 Speed"),
    notes: ("Cannot use Sidestep.",),
  ),
  armor(
    "Ceremonial Plate",
    ("-35% damage", "-2 Evasion", "-1 Speed", [#advantage(1) on Persuasion]),
  ),

  armor(
    "Wooden Shield",
    ("-1 damage", "-15% incoming ranged damage"),
    notes: ("Cannot use with two-handed weapons.",),
  ),
  armor(
    "Iron Shield",
    ("-2 damage", "-25% incoming ranged damage"),
    notes: ("Cannot use with two-handed weapons.",),
  ),
  armor(
    "Tower Shield",
    ("-3 damage", "-2 Evasion", "-1 Speed", "-50% incoming ranged damage"),
    notes: ("Cannot use with two-handed weapons.",),
  ),
  armor("Buckler", ("-1 damage", "-10% incoming ranged damage")),
)
#pagebreak()
...
#grid(
  ...
  armor("Scout's Leathers", ("-10% damage", "+1 Speed", [#advantage(1) on Stealth])),
  ...
  armor(
    "Gilded Brigandine",
    ("-25% damage", "-1 Evasion", [#advantage(1) on Persuasion]),
  ),
  armor(
    "Mirrorguard",
    ("-20% damage", "-1 Evasion"),
  ...
  armor(
    "Ironbark Shield",
    ("-2 damage", "-25% elemental damage", "-20% incoming ranged damage"),
    notes: ("Cannot use with two-handed weapons.",),
  ),
  armor(
    "Living Armor",
