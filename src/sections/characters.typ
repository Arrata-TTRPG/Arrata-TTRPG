...
aspects of characters that don't deserve an entire section:

- Name: What they're known as. Self-explanatory, but could also include pseudonyms
  and nicknames.
...
people, that's been abstracted into a stat. This can be extremely useful to
quantify something not necessarily quantifiable and then to allow something
quantified to become part of the system in a way that allows it to be used in
rolls.

What stat resources a character has and how they function are things to discuss
with the GM and other players. If you feel uncomfortable with this mechanic or
would rather use exact numbers or roleplay to represent these things, then feel
free to ignore Stat Resources altogether.
...
developing - these are things you use to _pick locks_, _fight monsters_, _make deals_,
and _fight for what you believe in_.

Skills are functionally identical to stats, containing a _Quality_ and _Quantity_,
but they also come with a _Root_ - which designates the core stat the skill is
derived from. The root of a stat represents what aspects of the character are
being leveraged for the skill. This can be helpful when determining what exactly
a skill does; often times combat skills will use their _Root_ to determine the
damage they deal, _Magic_ skills might use their root to determine how powerful
a spell is, and so on.

Skills also come with a description, although this is often not written on one's
character sheet. The description details what the skill governs, how it can be
used in rolls, and what effects it has. These descriptions are usually
open-ended and focus more on giving a basic outline of a skill than the letter
of law it's governed by.
...
Once the check pool reaches a value of 2 times the Quantity of the stat, the
stat immediately levels up! You can then rejoice as you increase the Quantity by
+1, and reset the check pool back to 0.

Depending on your character sheet, the check pool may be represented as a
designated area to record the current value, such as filling in empty circles or
...
category alongside with all of your check points (_even if there's more than
needed!_). I offer this as an interesting addition to leveling to try and force
more numbers-inclined players to focus on roleplay while still being able to
...
Quantity of its specified Stat.

You do not need to lock a roll in for a given stat - often in the character
creation stage we will rewrite the character once or twice, so if a given roll
...
Note that this is a shared pool; if the GM specifies a pool of 10, all of the
Quantities of your Stats should sum to 16 (10 + 6 Core Stats).

Here is a set of ranges of Point Buy values and what level of experience they
...
It's of the utmost importance to keep track of everything you can on the
character sheet and to be honest. Liars who cheat end up ruining the game for
everyone and should be removed from the game.

There will be provided a character sheet with this guide in the form of a PDF
for you to print, although these require a lot of work to maintain with the
...
However, physical character sheets can be wasteful. They can be damaged, lost,
written on with pen, eaten by your dog, and a whole many more tragedies. That's
why I've created an app to create, track, and store character sheets! Currently
it's under the GitHub repos of #link("https://github.com/kalebvonburris/Arrata-APP")[Arrata-APP] and
