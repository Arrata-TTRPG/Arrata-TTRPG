...
In using this system, a fictional world is constructed by a _Game Master_ (GM). This world is populated with characters and given things like factions, peoples, places, and conflict; things that make the world alive and interactable. _Players_ take control of _Player Characters_ (PCs) who are built with _Quirks_ that define who they are as people, and _Stats_ that define what they are as beings in the world. Together, the players and GM create a story with the PCs as the protagonists; their actions being influenced by their Quirks and the outcomes of their decisions determined by their Stats.
...
As a GM, you have the most responsibility; orchestrating sessions and campaigns, managing NPCs, handling disputes, etc. Your Players are counting on you to prepare and improvise as well as you can. If the responsibility required is too much for you to handle, I suggest being a Player. There isn't anything wrong with not being a GM, but having a bad GM is a million times worse than having a bad Player.
...
However, it is important not to overstep your authority as the GM. Punishing Players unfairly or making nonsensical rulings are unacceptable. If you find yourself under a GM making such decisions, the best course of action is typically to discuss the issue with the other Players and GM. Mediation and communication are critical skills in roleplaying, but if you fail to solve your issues, it's usually best to leave the group altogether.

== Players and their Characters

Players are the people in charge of player characters (PCs); their job is to be the "soul" driving their character. Players are charged with the following responsibilities:
...
PCs are the protagonists of any Arrata game. They exist to provide a player with a point of view on the collective story being told, and to allow that player to interact with the story. Their PC is the primary responsibility of the Player, and thus if a conflict arises regarding your PC, it is the duty of the Player to back up their PC and fight on their behalf.

== Non-Player Characters
Non-Player Characters (NPCs) are characters in the story created by the GM or players that act without player input. Instead, the GM acts as the "soul" of every NPC and treats one of many of their characters. 

GMs can generate hundreds or even thousands of NPCs throughout long campaigns, so NPCs that are underdeveloped or single-purpose are acceptable as long as they are not used in a derogatory or offensive manner.
