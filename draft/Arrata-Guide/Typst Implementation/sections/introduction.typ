...
Doing things is often far more valuable and teachable than observing. Part of that is that _you will fail_. You will also succeed in creating your vision, although rarely in the manner you may be expecting. The great thing about fictional worlds is that they have no physical consequences, they cannot and will not hurt you, so you are free to try the things you want to, and to fail in awesome ways.

In using this system, a fictional world is constructed by a _Game Master_ (GM). This world is populated with characters and given things like factions, populations, and conflict, things that make it alive and interactable. _players_ take control of _player characters_ (PCs) who are built with _Quirks_ that define who they are as people, and _Stats_ that define what they are as beings that interact with the world. Together, the players and GM create a story with the PCs as the protagonists, their actions being influenced by their Quirks and the outcomes determined by their Stats.
