...
_Note: Bring your GM treats; they may consider your PC's Boons._
    ...
    *Boons*: People will often trust or believe you. They might see you as an ally when things are wrong in the world.

    *Flaws*: You may often disclose things you should not. When there is great abundance, you may be seen as archaic.
]
...
#align(center)["_Do I want to be me? Do I accept who I am, or should I change?_"]

Fighting against Quirks is the key to _Change_ in Arrata. You as a player are the controller of your character and are ultimately the one who pilots the fate of your character. Part of that fate is deciding if a character _Accepts_ or _Rejects_ their Quirks.

=== Acceptance and Rejection

_Acceptance_ and _Rejection_ are measures of how much a character likes or dislikes a particular Quirk. Utilizing a Quirk in ways that demonstrate not only a reliance on the Quirk, but trust and belief in that aspect of the character is likely to increase your character's Acceptance of that Quirk. Doing the opposite; Fighting a Quirk (and succeeding), increases its Rejection.
...
Argos should incorporate a character's Quirks; if they're _Caliban_, then so should their Argos, if they're _Corrupt_, then their Argos should be underhanded, if they're _Cursed_, then they should be fighting with or against that curse.
...
If still, they continue to ignore or fight against their Argos, it's the GM's job to intervene. Characters who have a purpose but don't care for it will lose it, and revert to their original, purposeless existence. Remove these characters (and probably their player) from the table immediately. This is one rule that is immutable in Arrata: *Evict purposeless characters and the players who lead them to this*. If the situations and events that have occurred make it such that they lose their Argos, that is acceptable. But if a player's actions drag their character time and again away from their purpose, then they're actively breaking the rules of this system. Take necessary action and remove them.
