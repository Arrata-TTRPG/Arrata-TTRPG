...
\begin{document}
    ...
    \begin{itemize}
        \item Rolling $B2\text{\; vs \;}Ob\; 1: (2, 2)>3\text{\; vs \;}Ob\; 1 =$ 0 Successes vs $Ob\; 1$ = $failure$.
        \item Rolling $A4\text{\; vs \;}Ob\; 2: (5, 6, 3, 5)>2\text{\; vs \;}Ob\; 2 =$ 4 Successes vs $Ob\; 2$ = $pass$.
        \item Rolling $S6\text{\; vs \;}Ob\; 4: (1, 5, 1, 2, 3, 4)>1\text{\; vs \;}Ob\; 4 =$ 4 Successes vs $Ob\; 4$ = $pass$.
        \item \dots
    \end{itemize}
    ...
    \begin{itemize}
        \item $!B3 =\; !(6, 4, 6)>3 = 2$\; Successes $+\; !B2 = $\; 2 Successes $ +\; !(4, 2)>3 = $ \textbf{3 Successes}.
        \item $!G4 =\; !(6, 2, 3, 5)>2 = 3$\; Successes $+\; !G1 = $\; 3 Successes $+\; !(4)>2 = $ \textbf{4 Successes}.
        \item $!S6 =\; !(6, 4, 6, 3, 5, 3)>1 = 6$\; Successes $+\; !S2 = $\; 6 Successes $+\; !(2, 2)>1 = $ \textbf{8 Successes}.
    \end{itemize}
    ...
    % Fix examples.
    \begin{itemize}
        \item !`$B3 =\; $!`$(6, 4, 1)>3 = 2$\; Successes $ - 1 = $ \textbf{1 Success}.
        \item !`$G4 =\; $!`$(6, 1, 3, 5)>2 = 3$\; Successes $ - 1 = $ \textbf{2 Sucesses}.
        \item !`$S6 =\; $!`$(6, 1, 6, 3, 5, 1)>1 = 4 $ Successes $ - 2 = $ \textbf{2 Successes}.
    \end{itemize}
